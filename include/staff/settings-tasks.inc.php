...
<ul class="tabs" id="tasks-tabs">
    <li class="active"><a href="#settings">
        <i class="icon-cog"></i> <?php echo __('Settings'); ?></a></li>
    <li><a href="#alerts">
        <i class="icon-bell-alt"></i> <?php echo __('Alerts &amp; Notices'); ?></a></li>
</ul>
<div id="tasks-tabs_container">
   <div id="settings" class="tab_content">
    <table class="form_table settings_table" width="100%" border="0" cellspacing="0" cellpadding="0">
        <thead>
            <tr>
                <th colspan="2">
                    <em><strong><?php echo __('Global default task settings and options.'); ?></strong></em>
                </th>
            </tr>
        </thead>
        <tbody>
   ...
   <div id="alerts" class="tab_content" style="display:none;">
    <table class="form_table settings_table" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
            <tr><th><em><b><?php echo __('Neva Alerta de Tarea'); //echo __('New Task Alert'); ?></b>:
            ...
            <tr><th><em><b><?php echo __('Alerta de Nueva Actividad'); //echo __('New Activity Alert'); ?></b>:
            ...
            <tr><th><em><b><?php echo __('Alerta de Asignaci&oacute;n de tarea'); //echo __('Task Assignment Alert'); ?></b>:
            ...
            <tr><th><em><b><?php echo __('Alerta de Transferecia de Tarea'); //echo __('Task Transfer Alert'); ?></b>:
            ...
            <tr><th><em><b><?php echo __('Alerta de Tareas Vencidas'); //echo __('Overdue Task Alert'); ?></b>:
