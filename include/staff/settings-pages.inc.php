...
<ul class="clean tabs">
    <li class="active"><a href="#basic-information"><i class="icon-cog"></i>
...
<table class="form_table settings_table" width="100%" border="0" cellspacing="0" cellpadding="0">
    <thead>
        <tr>
            <th colspan="2">
                <em><strong><?php echo __('System Default Logo'); ?><i class="help-tip icon-question-sign" href="#logos"></i></strong></em>
            </th>
        </tr>
    </thead>
    <tbody>
            ...
            <td colspan="2">
                <table style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th colspan="3">
                                <em><strong><?php echo __('Use a custom logo'); ?>&nbsp;<i class="help-tip icon-question-sign" href="#upload_a_new_logo"></i></strong></em>
                            </th>
                        </tr>
                        <?php
