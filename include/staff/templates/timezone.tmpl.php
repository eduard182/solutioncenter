...
return false;" style="float: left;vertical-align: middle;margin-left: 5px;height: 30px;padding: 0px 6px!important;"><i class="icon-map-marker"></i> <?php echo __('Auto Detect'); ?></button>
