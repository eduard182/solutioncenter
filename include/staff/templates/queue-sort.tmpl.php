...
<span class="action-button muted sort" data-dropdown="#sort-dropdown" data-toggle="tooltip" title="<?php echo $sort_options[$sort_cols]; ?>">
<div class="caret">
				<i class="material-icons more sort">expand_more</i>
			</div>
