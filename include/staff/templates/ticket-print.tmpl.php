...
<htmlpagefooter name="def" style="display:none">
    ...
    <table width="100%"><tr><td class="flush-left">
        ...
        OC #<?php echo $ticket->getNumber(); ?> impreso por
...
<!--
<h2>Ticket #<?php echo $ticket->getNumber(); ?></h2>-->


    <table>
		<tr>
			<td class="flush-left"><h4>Orden #<?php echo $ticket->getNumber(); ?></h4></td>
			<td class="flush-right"><?php echo "| ".Format::daydatetime(Misc::gmtime()); ?></td>
		</tr>
    </table>
     <div class="hr">&nbsp;</div>

<table class="meta-data" cellpadding="0" cellspacing="0" style=" margin-top: 10px;">
<tbody>
<tr>
