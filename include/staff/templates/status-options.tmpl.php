...
<a id="tickets-action" href="#statuses">
	<div id="status" class="action-button change-status gray" data-dropdown="#action-dropdown-statuses" style="/*DELME*/">
		<div id="button-more-inner">
			<div class="button-icon miclass">
				<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
     viewBox="0 0 60 60" style="enable-background:new 0 0 60 60;width: 27px;
