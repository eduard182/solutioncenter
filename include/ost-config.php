...
define('SECRET_SALT','OC4=gnpq24MXA0ghWcDTlanaJtPCT1z4');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','jorge.gonzalez@mtsolutioncenter.com');
...
define('DBNAME','mtsolution');
define('DBUSER','dev18266');
define('DBPASS','admin18266');
