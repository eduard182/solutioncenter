...
implements TemplateVariable {
    ...
    static function setManagerUser($id){//// METODO QUE ACTUALIZA AL USUARIO Y LO COLOCA COMO MANAGER

        $update="UPDATE ost_user SET ismanager=(NOT ismanager) WHERE id ={$id};";

        if (!db_query($update)) return false;
