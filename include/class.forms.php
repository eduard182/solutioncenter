...
class FormField {
    ...
    function getFormName() {
        ...
        /// CAMBIO APLICADO POR FCOLMENAREZ PARA MEJORAR MOSTRAR LOS NOMBRES DE LOS OBJETOS PARA LOS FORMULARIOS DE OC Y TAREAS EL RESTO QUEDA DINAMICO
        if ($this->ht["form_id"]=='10'  || $this->ht["form_id"]=='2' || $this->get('name')=='duedate'){

            return $this->get('name') ?: $this->get('id');

        }else{
            if (is_numeric($this->get('id'))) 
                return substr(md5(session_id() . '-field-id-'.$this->get('id')), -16);
            else return $this->get('name') ?: $this->get('id');
        }
...
class DatetimePickerWidget extends Widget {
    function render($options=array()) {
        ...
        <input type="text" name="<?php echo $this->name; ?>"
            id="<?php echo $this->id; ?>" style="display:inline-block;width:160px!important;"
        ...
        ?><div id="<?php echo $id;
            ...
            <div class="dropzone">
				<svg style="width:24px;height:24px; vertical-align: middle;" viewBox="0 0 24 24">
					<path fill="#747373" d="M9,16V10H5L12,3L19,10H15V16H9M5,20V18H19V20H5Z"></path>
				</svg>			
            <?php echo sprintf(
