...
class StaffNav {
    ...
    function getTabs(){
        ...
        if(!$this->tabs) {
            ...
            $this->tabs['tasks'] = array('desc'=>__('Tareas'), 'href'=>'tasks.php', 'title'=>__('Task Queue'));
            $this->tabs['tickets'] = array('desc'=>__('Tickets'),'href'=>'tickets.php?status=received','title'=>__('Ticket Queue'));
        ...
        foreach($this->getTabs() as $k=>$tab){
            ...
            switch(strtolower($k)){
                case 'tasks':
                    ...
                    break;
                case 'tickets':
                    $subnav[]=array('desc'=>__('Tickets'),'href'=>'tickets.php?status=received','iconclass'=>'Ticket', 'droponly'=>true);
                    if($staff) {
        ...
        foreach($this->getTabs() as $k=>$tab){
            ...
            switch(strtolower($k)){
                ...
                case 'settings':
                    ...
                    $subnav[]=array('desc'=>__('Tareas'),'href'=>'settings.php?t=tasks','iconclass'=>'lists');
