...
class TasksAjaxAPI extends AjaxController {
    ...
    function massProcess($action)  {
        ...
        case 'assign':
            ...
            $info[':title'] = sprintf('Asignar %s',
                    _N('Tarea Seleccionada', 'Tareas Seleccionadas', $count));
        ...
        case 'transfer':
            ...
            $info[':title'] = sprintf('Trasferir %s',
                    _N('Tarea Seleccionada', 'Tareas Seleccionadas', $count));
        ...
        case 'status6':
            ...
            if ($perm && !$thisstaff->hasPerm($perm, false))
                $errors['err'] = sprintf(__('NO teiene Permiso para cambiar el Estado de las %s'),__('tasks'));

            if ($_POST && !$errors) {

                if (!$_POST['status'] || !in_array($_POST['status'], array('1', '2','3','4','5','6')))
                    $errors['status'] = __('Status selection required');
                else {
