jQuery(function() {
    var showtip = function (url, elem,xoffset) {
            ...
            var tip_content = $('<div>').addClass('tip_content').load(url, function() {
                if (elem.is(':visible')) {
                    tip_content.prepend('<a href="#" class="tip_close"><i class="material-icons">highlight_off</i></a>').append(tip_arrow);
                    ...
                    if (flip) {
                        the_tip.css({'left':x_pos-tip_content.outerWidth()-elem.width()-82+'px'});
    ...
    .on('mouseover click', '.help-tip', function(e) {
        ...
        var elem = $(this),
            ...
            tip_box = $('<div>')
                .addClass('tip_box'),
            tip_content = $('<div>')
                .append('<a href="#" class="tip_close"><i class="material-icons">highlight_off</i></a>')
        ...
        getHelpTips(elem).then(function(tips) {
            ...
            tip_content.append(
                $('<h1>')
                    .append('<svg viewBox="0 0 24 24"><path style="color:currentColor;" d="M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z" /></svg>')
